...
- the manager report includes a `Schedule Cascade Review` section that visualizes changed finish dates by dependency branch and includes a collapsible detail table
