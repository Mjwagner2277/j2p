...
- completed driving epics remain active at native 100%; configured Gantt-bar hiding is best effort, and copies remain active with manual dates and no assignments with custom story-point progress
